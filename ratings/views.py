...
class ActivityRatingsView(APIView):
    ...
    def post(self, request, activity_id):
        ...
        recalculate_organizer_rating.delay(activity.organizer_id)

        # уведомление организатору о новой оценке — тоже в фоне
        notify_organizer_of_new_rating.delay(rating.id)
